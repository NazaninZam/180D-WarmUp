// REFERENCES: https://www.makerguides.com/how-to-use-an-mpu6050-3-axis-accelerometer-and-3-axis-gyrosensor-with-arduino/
...
void loop() {
  ...
  /*if (abs(g.gyro.z) > TOLERANCE){
    Serial.println("Detected Motion in Z-axis");
  }*/
